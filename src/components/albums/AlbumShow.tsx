  ...
  return (
    <div className="pt-12 flex flex-col lg:justify-center items-center gap-4 lg:gap-12 p-4">
      <div className="flex flex-col lg:flex-row items-center gap-6">
        ...
        />
        <div className="flex flex-col gap-2 whitespace-nowrap items-center text-gray-600 lg:text-xl">
          <Link
          ...
          <div className="flex flex-col mt-3 items-center lg:text-base text-sm">
